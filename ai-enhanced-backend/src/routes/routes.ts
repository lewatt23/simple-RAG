...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":314572800}});
        ...
        app.post('/chat/upload',
            ...
            ...(fetchMiddlewares<RequestHandler>(ChatController.prototype.uploadDocument)),

            async function ChatController_uploadDocument(request: ExRequest, response: ExResponse, next: any) {
        ...
        app.post('/chat/ask',
            ...(fetchMiddlewares<RequestHandler>(ChatController)),
            ...(fetchMiddlewares<RequestHandler>(ChatController.prototype.askQuestion)),

            async function ChatController_askQuestion(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
